...
return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>sw", require("fzf-lua").lsp_workspace_symbols, { desc = "LSP: Global Symbols" })

        -- diagnostics
        vim.keymap.set("n", "<leader>dq", require("fzf-lua").quickfix, { desc = "LSP: Quickfix" })
        vim.keymap.set("n", "<leader>df", require("fzf-lua").diagnostics_document, { desc = "LSP: Document Diagnostics" })
        vim.keymap.set("n", "<leader>dw", require("fzf-lua").diagnostics_workspace, { desc = "LSP: Workspace Diagnostics" })
        -- maps
        vim.keymap.set("n", "<leader>km", require("fzf-lua").keymaps, { desc = "FZF: Keymaps" })
        vim.keymap.set("n", "<leader>cm", require("fzf-lua").commands, { desc = "FZF: Commands" })
    end,
}
